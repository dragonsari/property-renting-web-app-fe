...
import { AnimatePresence, motion } from "motion/react";
import { IconMenu2, IconX } from "@tabler/icons-react";
import Link from "next/link"; // ✅ WAJIB
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "fixed inset-0 bg-white dark:bg-neutral-900 p-10 z-50 flex flex-col",
              className
            )}
          >
            <div
  ...
  return (
    ...
    >
      ...
      <motion.span
        ...
        className="text-sm text-neutral-700 dark:text-neutral-200 group-hover/sidebar:translate-x-1 transition"
      >
        {link.label}
      </motion.span>
    </Link>
